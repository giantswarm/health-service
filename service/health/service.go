...
// GetHealth accepts data from the control plane and tenant cluster and returns
// an object representing an aggregate health of the cluster and its nodes.
func (s *Service) GetHealth(ctx context.Context, request Request) (*Response, error) {
